...
public class ControllerImpl implements Controller {
    private restaurant.repositories.interfaces.HealthFoodRepository<HealthyFood> foodRepository;
    private restaurant.repositories.interfaces.BeverageRepository<Beverages> beverageRepository;
    private restaurant.repositories.interfaces.TableRepository<Table> tableRepository;

    private double totalWon;

    public ControllerImpl(restaurant.repositories.interfaces.HealthFoodRepository<HealthyFood> healthFoodRepository,
                          restaurant.repositories.interfaces.BeverageRepository<Beverages> beverageRepository,
                          restaurant.repositories.interfaces.TableRepository<Table> tableRepository) {
